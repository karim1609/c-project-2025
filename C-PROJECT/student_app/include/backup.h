...
typedef enum {
    ...
    BACKUP_ERROR_INVALID_PARAMETERS = -8,
    BACKUP_ERROR_SOURCE_DIR_NOT_FOUND = -9,
    BACKUP_ERROR_BACKUP_DIR_NOT_FOUND = -10,
    BACKUP_ERROR_BACKUP_DIR_ALREADY_EXISTS = -11,
    BACKUP_ERROR_BACKUP_DIR_NOT_EMPTY = -12,
    BACKUP_ERROR_BACKUP_DIR_NOT_READABLE = -13,
    BACKUP_ERROR_BACKUP_DIR_NOT_WRITABLE = -14,
} BackupResult;
